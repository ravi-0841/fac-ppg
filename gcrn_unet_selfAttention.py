...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 11 14:53:07 2023
...
class GCRN(nn.Module):
    def __init__(self):
        ...
        self.mha = nn.MultiheadAttention(64*7, 4, 
                                        dropout=0.5)
    ...
    def forward(self, x):
        ...
        out = e5.permute(2,0,1,3)
        out_shape = out.shape
        out = out.flatten(start_dim=-2, end_dim=-1)
        out, _ = self.mha(out, out, out, need_weights=False)
        out = out.reshape(out_shape)
        out = out.permute(1,2,0,3)

        # print("out shape and e5 shape: ", out.shape, e5.shape)
        ...
        # out_lstm = out.squeeze().permute(1,0,2)
        ...
        return out#, out_lstm.reshape(-1,64*7)
