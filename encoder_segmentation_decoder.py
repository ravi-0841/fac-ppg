...
# -*- coding: utf-8 -*-
"""
Created on Fri Jan 13 14:57:50 2023
...
class EncoderDecoder(nn.Module):
    ...
    #     self.encoder_linear = nn.Linear(in_features=256, out_features=1)
    ...
    #     # x -> shape [batch, #stft bins, #time frames]
    ...
    #     mask = sampled_val.repeat(1, 1, 257)
    #     print("4. mask shape: ", mask.shape)

    #     enc_out = x * mask.permute(0,2,1)
    #     e1_dec = self.elu(self.bn1_dec(self.conv1_dec(enc_out)))
    ...
    def forward(self, x):
        ...
        sampled_val = sampler.sample()
        mask = sampled_val.repeat(1, 1, 256)
        print("4. mask shape: ", mask.shape)
