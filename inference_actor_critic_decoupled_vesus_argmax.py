...
from block_pitch_duration_AC_decoupled import MaskedRateModifier, RatePredictorActor
...
def load_model(hparams):
    ...
    model_rate = RatePredictorActor(temp_scale=1.).cuda()
...
def load_checkpoint_rate(checkpoint_path, model_rate):
    ...
    model_rate.load_state_dict(checkpoint_dict['state_dict_actor'])
...
if __name__ == '__main__':
    ...
    for m in range(1000, 350000, 1000): # max
