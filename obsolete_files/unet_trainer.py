...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec  6 15:50:12 2022
...
def validate(model, criterion, valset, iteration, batch_size, n_gpus,
    ...
    if rank == 0:
        ...
        logger.log_validation(val_loss, model, x, y, y_pred, iteration)
...
def train(output_directory, log_directory, checkpoint_path, warm_start, n_gpus,
    ...
    criterion = SpectrogramL1Loss() #nn.MSELoss()
