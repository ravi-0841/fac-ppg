...
# -*- coding: utf-8 -*-
"""
Created on Fri May 26 15:21:18 2023
...
def test(output_directory, checkpoint_path, hparams, valid=True):
    ...
    for i, batch in enumerate(test_loader):
        ...
        loss_array.append(reduced_loss)
        pred_array.append(np.mean(pred_data, axis=0))
        std_array.append(np.std(pred_data, axis=0))
        targ_array.append(y)
    ...
    return cunk_array, targ_array, pred_array, std_array
...
if __name__ == '__main__':
    ...
    chunk_array, targ_array, pred_array, std_array = test(
                                                        hparams.output_directory,
