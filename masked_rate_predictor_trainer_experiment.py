...
from saliency_predictor_RL_experiment import MaskedRateModifier, RatePredictor
...
from src.common.hparams_onflyenergy_rate_experiment import create_hparams
...
def validate(model_saliency, model_rate, WSOLA, criterion, valset, 
    ...
    with torch.no_grad():
        ...
        for i, batch in enumerate(val_loader):
            ...
            loss_rate = torch.mean(1 - y_pred.gather(1,cats.view(-1,1)).view(-1))
            ...
            try:
                ...
                if (iteration % hparams.iters_per_checkpoint == 0):
                    validate(model_saliency, model_rate, WSOLA, criterion1, valset, 
                             collate_fn, iteration, hparams.batch_size, rate_classes, 
