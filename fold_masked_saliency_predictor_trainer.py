...
# -*- coding: utf-8 -*-
"""
Created on Sat Feb  4 16:24:44 2023
...
def create_folds(hparams, fold=1):
    if (os.path.exists("./temp/train_fold_{}.txt".format(fold)) 
        and os.path.exists("./temp/valid_fold_{}.txt".format(fold))
        and os.path.exists("./temp/test_fold_{}.txt".format(fold))
        ):
        return None
    else:
