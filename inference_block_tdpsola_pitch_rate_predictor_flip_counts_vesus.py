...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep 25 15:58:41 2023
...
from src.common.hparams_onflyenergy_block_tdpsola_pitch_rate_vesus import create_hparams
from src.common.interpolation_block import WSOLAInterpolationBlockEnergy
from src.common.pitch_modification_block import LocalPitchModification_TDPSOLA
...
def test(output_directory, checkpoint_path_rate, 
    ...
    OLA = LocalPitchModification_TDPSOLA(frame_period=10)
...
if __name__ == '__main__':
    ...
    for m in range(1000, 200000, 1000): #max2
