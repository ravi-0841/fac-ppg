...
def create_hparams(**kwargs):
    ...
    hparams = {
        ...
        "checkpoint_path_inference": "./masked_predictor_output/VESUS_entropy_0.05_AC_10_masked_encoder_updated_data_hlr/checkpoint",
        ...
        "lambda_entropy": 0.05,
        "lambda_entropy_rate": 0.1, #0.05,
        "lambda_entropy_pitch": 0.05,
        "lambda_entropy_energy": 0.05,
        "lambda_critic": 10,
        "temp_scale": 5.0, #15.0
        "exploration_decay": 1.03183,
        "use_saved_learning_rate": False,
        "learning_rate_rate": 1e-4, #1e-5
