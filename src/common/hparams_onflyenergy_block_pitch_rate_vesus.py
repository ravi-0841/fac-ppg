...
def create_hparams(**kwargs):
    ...
    hparams = {
        ...
        "log_directory": './logs',
        "extended_desc": "temp_0.5_RE_L1_loss", # extra description for logging/identification
        ...
        "checkpoint_path_inference": "./masked_predictor_output/VESUS_Block_Local_PitchRate_entropy_0.1_exploit_0.15_temp_0.2_RE_L1_loss_max_2/checkpoint",
