...
def create_hparams(**kwargs):
    ...
    hparams = {
        ...
        "checkpoint_path_inference": "./masked_predictor_output/VESUS_entropy_0.1_AC_10_energy_encoder_updated_data/checkpoint",
        ...
        "lambda_entropy": 0.7, #0.01,
        "lambda_critic": 10,
        "temp_scale": 5.0, #15.0
        "exploration_decay": 1.03183,
        "use_saved_learning_rate": False,
        "learning_rate_rate": 1e-4, #1e-4
