...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov 10 11:53:34 2022
...
MINILIBRI_TRAIN_URL = "http://www.openslr.org/resources/12/train-clean-100.tar.gz"
MINILIBRI_VALID_URL = "http://www.openslr.org/resources/12/dev-clean.tar.gz"
...
def prepare_mini_librispeech(
    ...
    valid_folder = os.path.join(data_folder, "LibriSpeech", "dev-clean")
...
def download_mini_librispeech(destination):
    ...
    """
    train_archive = os.path.join(destination, "train-clean-500.tar.gz")
    valid_archive = os.path.join(destination, "dev-clean.tar.gz")
