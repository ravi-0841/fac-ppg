...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb 17 14:45:26 2023
...
def load_checkpoint(checkpoint_path, model, optimizer):
    ...
    checkpoint_dict = torch.load(checkpoint_path, map_location='cpu')
    model.load_state_dict(checkpoint_dict['state_dict_saliency'])
    optimizer.load_state_dict(checkpoint_dict['optimizer_saliency'])
    learning_rate = checkpoint_dict['learning_rate_saliency']
